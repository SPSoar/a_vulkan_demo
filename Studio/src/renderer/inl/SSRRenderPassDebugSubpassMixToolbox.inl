...
_SSR_MOTIONLESS_FLOW_IFUNC_BEGIN(CF_DebugSubpassMix_Init_Self)
    ...
    dependency2.p.dstPipelineStage = _SSR_CORE::RE_PipelineStage::eBottomOfPipe;
    dependency2.p.srcAccessMode = _SSR_CORE::RE_AccessMode::eColorAttachmentReadAndWrite;
    dependency2.p.dstAccessMode = _SSR_CORE::RE_AccessMode::eMemoryRead;

    passInfo.mConfig.p.usage = SE_PassUsage::ePostProcessing;
    passInfo.mMaterialVariant.set_color(true);

    _SSR_CREATE_OBJECT_PTR(passDetail, SSRRenderPassDebugSubpassMix::PassDetail);

_SSR_MOTIONLESS_FLOW_IFUNC_END

_SSR_MOTIONLESS_FLOW_IFUNC_BEGIN(CF_DebugSubpassMix_Prepare_Self)
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(pipelineIndex, SSRRenderPassDebugSubpassMix::PassPrepare::ePipelineIndex);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(passIndex, SSRRenderPassDebugSubpassMix::PassPrepare::ePassIndex);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(passInfo, SSRRenderPassDebugSubpassMix::PassPrepare::ePassInfo);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(passDetail, SSRRenderPassDebugSubpassMix::PassPrepare::ePassDetail);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(renderGraphInfo, SSRRenderPassDebugSubpassMix::PassPrepare::eRenderGraphInfo);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(renderEntity, SSRRenderPassDebugSubpassMix::PassPrepare::eRenderEntity);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(renderManager, SSRRenderPassDebugSubpassMix::PassPrepare::eRenderManager);
    ...
    if (passInfo.mConfig.p.usage == SE_PassUsage::ePostProcessing)
    {
        ...
        for (UINT32 i = 0; i < renderManager.get_frame_count(); i++)
        {
            ...
            //auto&& shaders = mPostProcessing.mShaders;
...
_SSR_MOTIONLESS_FLOW_IFUNC_BEGIN(CF_DebugSubpassMix_Build_Self)
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(pipelineIndex, SSRRenderPassDebugSubpassMix::PassBuild::ePipelineIndex);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(passIndex, SSRRenderPassDebugSubpassMix::PassBuild::ePassIndex);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(passInfo, SSRRenderPassDebugSubpassMix::PassBuild::ePassInfo);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(passDetail, SSRRenderPassDebugSubpassMix::PassBuild::ePassDetail);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(renderEntity, SSRRenderPassDebugSubpassMix::PassBuild::eRenderEntity);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(renderManager, SSRRenderPassDebugSubpassMix::PassBuild::eRenderManager);
...
_SSR_MOTIONLESS_FLOW_IFUNC_BEGIN(CF_DebugSubpassMix_Uninit_Self)
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(pipelineIndex, SSRRenderPassDebugSubpassMix::PassUninit::ePipelineIndex);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(passIndex, SSRRenderPassDebugSubpassMix::PassUninit::ePassIndex);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(passInfo, SSRRenderPassDebugSubpassMix::PassUninit::ePassInfo);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(passDetail, SSRRenderPassDebugSubpassMix::PassUninit::ePassDetail);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(renderEntity, SSRRenderPassDebugSubpassMix::PassUninit::eRenderEntity);
    _SSR_MOTIONLESS_FLOW_IFUNC_PAR(renderManager, SSRRenderPassDebugSubpassMix::PassUninit::eRenderManager);
...
_SSR_MOTIONLESS_FLOW_ABEGIN(CF_DebugSubpassMix_Init)
_SSR_MOTIONLESS_FLOW_APPEND(CF_DebugSubpassMix_Init_Self)
_SSR_MOTIONLESS_FLOW_END

_SSR_MOTIONLESS_FLOW_ABEGIN(CF_DebugSubpassMix_Prepare)
_SSR_MOTIONLESS_FLOW_APPEND(CF_DebugSubpassMix_Prepare_Self)
_SSR_MOTIONLESS_FLOW_END

_SSR_MOTIONLESS_FLOW_ABEGIN(CF_DebugSubpassMix_Build)
_SSR_MOTIONLESS_FLOW_APPEND(CF_DebugSubpassMix_Build_Self)
_SSR_MOTIONLESS_FLOW_END

_SSR_MOTIONLESS_FLOW_ABEGIN(CF_DebugSubpassMix_Uninit)
_SSR_MOTIONLESS_FLOW_APPEND(CF_DebugSubpassMix_Uninit_Self)
_SSR_MOTIONLESS_FLOW_END
